...
export default function BackofficeDelete({ docId, filePath }: { docId: string; filePath: string }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-1 text-xs text-red-500 hover:text-red-600 font-medium px-2 py-1 border border-red-200 rounded hover:bg-red-50 transition-colors">
